                                    ...
                                    <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                        <div class="input-group mb-3">
                                            <div class="custom-file">
                                                <input type="file" id="image_url" class="custom-file-input image-input"
                                                    data-preview="image_view" name="image_url"
                                                    accept=".png, .jpg, .jpeg">
                            ...
                            <fieldset class="border p-4 mb-4" id="partner">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <img src="" id="pbc_license_image_front_url_view" class="hidden w-25" />
                                    </div>
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <img src="" id="pbc_license_image_back_url_view" class="hidden w-25" />
                                    </div>
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="custom-file">
                                                <input type="file" id="cnic_image_front_url"
                                                    ...
                                                    data-preview="cnic_image_front_url_view" accept=".png, .jpg, .jpeg">
                                                <label class="custom-file-label" for="inputGroupFile01">Choose
                                                    file</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="custom-file">
                                                <input type="file" id="cnic_image_back_url"
                                                    ...
                                                    data-preview="cnic_image_back_url_view" accept=".png, .jpg, .jpeg">
                                                <label class="custom-file-label" for="inputGroupFile01">Choose
                                                    file</label>
                                            </div>
                                        </div>
