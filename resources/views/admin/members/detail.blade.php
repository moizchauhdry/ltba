                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                                            ...
                                            @if ($member->mem_fee_submission_date != null)
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-primary btn-sm"
                                                        data-toggle="modal" data-target="#modal-lg-{{ $member->id }}"
                                                        style="float:right;">
                                                        Payment Edit
                                                    </button>
                                                    <div class="modal fade" id="modal-lg-{{ $member->id }}"
                                                        ...
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                ...
                                                                <form action="#" id="member_payment_form"
                                                                    method="POST"> @csrf
                                                                    {{ csrf_field() }}
                                                                    <div class="modal-body">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="form-group col-md-6">
                                                                                ...
                                                                                <textarea class="form-control" name="remarks" id="remarks" cols="10" rows="2">{{ $member->remarks }}</textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                            ...
                            <fieldset class="border p-4 mb-4" id="partner">
                                <legend class="w-auto text-uppercase"><small>Attachments</small></legend>
                                <div class="row">
                                    <table class="table table-bordered text-uppercase">
                                        <tr>
                                            <th>PBC License Image Front</th>
                                            <td>
                                                @if (isset($member->license_front))
                                                    <img class="custom-image-preview"
                                                        src="{{ asset('storage/app/public/' . $member->license_front) }}">
                                                @else
                                                    <img class="custom-image-preview"
                                                        src="{{ asset('public/images/dummy-image.png') }}">
                                                @endif
                                            </td>
                                            <th>PBC License Image Back</th>
                                            <td>
                                                @if (isset($member->license_back))
                                                    <img class="custom-image-preview"
                                                        src="{{ asset('storage/app/public/' . $member->license_back) }}">
                                                @else
                                                    <img class="custom-image-preview"
                                                        src="{{ asset('public/images/dummy-image.png') }}">
                                                @endif
                                        ...
                                        <tr>
                                            <th>CNIC Image Front</th>
                                            <td>
                                                @if (isset($member->cnic_front))
                                                    <img class="custom-image-preview"
                                                        src="{{ asset('storage/app/public/' . $member->cnic_front) }}">
                                                @else
                                                    <img class="custom-image-preview"
                                                        src="{{ asset('public/images/dummy-image.png') }}">
                                                @endif
                                            </td>
                                            <th>CNIC Image Back</th>
                                            <td>
                                                @if (isset($member->cnic_back))
                                                    <img class="custom-image-preview"
                                                        src="{{ asset('storage/app/public/' . $member->cnic_back) }}">
                                                @else
                                                    <img class="custom-image-preview"
                                                        src="{{ asset('public/images/dummy-image.png') }}">
                                                @endif
