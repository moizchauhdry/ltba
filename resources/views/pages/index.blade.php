                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.status == 1) {
                            ...
                            var memberData = '<div class="row"><div class="col-md-6"><th>Member #:</th></div><div class="col-md-6"><td><b>'+ response.member.mem_no +'</b></td></div><div class="col-md-4"><th>Name :</th></div><div class="col-md-6"><td><b>'+ response.member.name +'</b></td></div><div class="col-md-4"><th>Cnic No :</th></div><div class="col-md-6"><td><b>'+ response.member.cnic_no +'</b></td></div></div><div class="modal-footer justify-content-between"><a  href="javascript:void(0);"  onclick="nextPage('+ response.member.id +');" class="btn btn-primary" style="float:right;">Next</a></div>';
        ...
        function nextPage(mem_id)
        {
            $.ajax({
                ...
                success: function (response) {
                    if (response.status == 1) {
                        var id = response.id;
                        window.location.href =  ("/tax-bar/edit/" + id);
                    }
                },
            });
        }
